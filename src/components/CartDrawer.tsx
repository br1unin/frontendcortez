          ...
          >
            <div className="flex items-center justify-between border-b border-black/10 p-4">
              <div>
                ...
                <div className="text-xs text-black/60">
                  {cartLines.items.length} item(s) - Subtotal {ARS.format(cartLines.subtotal)}
                </div>
              </div>
            ...
            <div className="h-[calc(100%-220px)] overflow-auto p-4">
              {cartLines.items.length === 0 ? (
                <div className="rounded-3xl border border-black/10 p-6 text-center">
                  <div className="text-sm font-semibold">Carrito vacio</div>
                  <div className="mt-1 text-sm text-black/60">Agrega productos para empezar.</div>
                </div>
              ) : (
            ...
            <div className="border-t border-black/10 p-4">
              ...
              <div className="mt-3 text-xs text-black/60">
                Demo: precios en ARS, envio gratis a partir de {ARS.format(65000)}.
              </div>
            </div>
          </motion.div>
        </motion.div>
